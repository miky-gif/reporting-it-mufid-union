...
export default function MyReports() {
  ...
  useEffect(() => {
    setChargement(true);
    api
      .get<Apercu>("/rapports/mien/apercu", { params: { date_debut: debut, date_fin: fin } })
  ...
  async function exporter(format: "pdf" | "word" | "excel") {
    ...
    try {
      await telechargerFichier("/rapports/mien", {
        date_debut: debut,
        date_fin: fin,
        format,
  ...
  return (
    <>
      <EnteteSection
        titre="Mes rapports"
        sousTitre="Exportez votre rapport d'activité. Le type (hebdomadaire, mensuel, annuel) est détecté d'après la période."
      />
